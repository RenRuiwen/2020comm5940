...
function openForm(recEntry,whichForm) {
    ...
    if (whichForm == 'add') {
       $("#myAddForm").modal();
        ...
        document.getElementById("add_site").value = '';
        document.getElementById("add_address").value = 0;
        document.getElementById("add_timeperiod").value = 0;
        // document.getElementById("add_record_id").value = recEntry[0];
    } else if (whichForm == 'update') {
       $("#myUpdateForm").modal();
        document.getElementById("upd_trip_id").value = recEntry[0];
        document.getElementById("upd_name").value = recEntry[2];
        document.getElementById("upd_site").value = recEntry[3];
        document.getElementById("upd_address").value = recEntry[4];
        document.getElementById("upd_timeperiod").value = recEntry[5];
        document.getElementById("upd_record_id").value = recEntry[0];
    } else {
        $("#myDeleteForm").modal();
        document.getElementById("del_trip_id").value = recEntry[0];
        document.getElementById("del_name").value = recEntry[2];
        document.getElementById("del_site").value = recEntry[3];
        document.getElementById("del_address").value = recEntry[4];
        document.getElementById("del_timeperiod").value = recEntry[5];
